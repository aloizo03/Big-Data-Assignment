...
# Repartition the RDDs by their keys to optimize the join
df_merged_rdd_repartition = df_merged_rdd.repartition(100)  # Adjust the number of partitions as needed
police_stations_rdd_repartition = police_stations_rdd.repartition(100)

# Join the data using the key-value pairs
joined_rdd = df_merged_rdd_repartition.join(police_stations_rdd_repartition)
